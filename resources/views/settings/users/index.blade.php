            ...
            @foreach ($users as $user)
              <li class="table-row">
                ...
                <div class="table-cell actions">
                  ...
                  @else
                    <a href="/settings/users/{{ $user->id }}/delete"
                       onclick="return confirm('{{ trans('settings.users_list_delete_confirmation') }}')">
            ...
            <ul class="table">
              @foreach (auth()->user()->company->invitations as $invitation)
                <li class="table-row">
                  ...
                  <div class="table-cell actions">
                    <a href="/settings/users/invitations/{{ $invitation->id }}/delete"
                       onclick="return confirm('{{ trans('settings.users_invitations_delete_confirmation') }}')">
                      <i class="fa fa-trash-o" aria-hidden="true"></i>
                    </a>
                  </div>
                </li>
