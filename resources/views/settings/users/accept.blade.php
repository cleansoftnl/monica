        ...
        <div class="signup-box">
          ...
          <form class="" action="/invitations/accept/{{ $key }}" method="post">
            ...
            <div class="form-group">
              ...
              <input type="email" class="form-control" id="email" name="email" placeholder="you@home"
            ...
            <div class="form-group">
              <label for="email_security">For security purposes, please indicate the email of the person who've invited
                you to join this account. This information is provided in the invitation email.</label>
            ...
            <div class="help">
              Signing up signifies you’ve read and agree to our <a href="https://monicahq.com/privacy">Privacy
                Policy</a>.
            </div>
