...
class AddContactFromVCard implements ShouldQueue
{
    ...
    public function handle()
    {
        try {
            ...
            collect($matches[0])->map(function ($vcard) {
                ...
                if ($this->contactExists($vcard, $this->importJob->company_id)) {
                ...
                $contact = new Contact();
                $contact->company_id = $this->importJob->company_id;
     ...
     * @return bool
     */
    private function contactExists(VCard $vcard, $company_id)
    {
    ...
    private function fileImportJobReport(VCard $vcard, $status, $reason = null)
    {
        ...
        $importJobReport->company_id = $this->importJob->company_id;
