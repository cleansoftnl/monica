<form method="POST" action="{{ $action }}">
  ...
  <fieldset class="form-group">
    <label class="form-check-inline" for="offered_0">
      <input type="radio" class="form-check-input" name="offered" id="offered_0" value="0"
             @if(old('offered') !== true || $gift->is_an_idea) checked @endif>
      {{ trans('people.gifts_add_gift_idea') }}
    </label>

    <label class="form-check-inline" for="offered_1">
      <input type="radio" class="form-check-input" name="offered" id="offered_1" value="1"
             @if(old('offered') === true || $gift->has_been_offered) checked @endif>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="url" id="url" value="{{ old('url') ?? $gift->url }}"
           placeholder="https://">
  </div>
  ...
  <div class="form-group">
    ...
    <input type="number" class="form-control" name="value_in_dollars" id="value_in_dollars" placeholder="0"
           value="{{ old('value_in_dollars') ?? $gift->value_in_dollars }}">
  </div>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="comment" name="comment"
              rows="3">{{ old('comment') ?? $gift->comment }}</textarea>
  </div>
