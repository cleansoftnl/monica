          ...
          <form action="/people" method="POST">
            ...
            @if (auth()->user()->name_order == 'firstname_first')
              ...
              <dl class="form-group {{ $errors->has('first_name') ? ' errored' : '' }}">
                ...
                <dd><input type="text" id="first_name" class="form-control" name="first_name" placeholder="" autofocus
                           value="{{ old('first_name') }}" autocomplete="off"></dd>
                @if ($errors->has('first_name'))
                  <dd class="error">{{ $errors->first('first_name') }}</dd>
                @endif

                <dt><label for="last_name">{{ trans('people.people_add_lastname') }}</label></dt>
                <dd><input type="text" id="last_name" class="form-control" name="last_name" placeholder=""
                           value="{{ old('last_name') }}" autocomplete="off"></dd>
